...
public class Updater {
    ...
    private static final String GITHUB_DOWNLOAD_LINK = "https://github.com/MrUniverse44/PixelMOTD3/releases/download/";

    private static final String GITHUB_API_RESOURCE = "https://api.github.com/repos/MrUniverse44/PixelMOTD3/releases/latest";
